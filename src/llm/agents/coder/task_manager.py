"""Task manager for the coder agent."""
...
class AgentTaskManager(InMemoryTaskManager):
    """Task manager for handling agent tasks."""
    
    def __init__(self, agent: CoderAgent, notification_sender_auth: PushNotificationSenderAuth):
        super().__init__()
        self.agent = agent
    ...
    async def on_send_task_subscribe(
        ...
        """Handle streaming task subscription."""
        try:
    ...
    async def set_push_notification_info(self, task_id: str, push_notification_config: PushNotificationConfig):
        """Set push notification information."""
